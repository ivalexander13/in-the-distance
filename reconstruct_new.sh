...
path="/data/yosef2/users/ivalexander13/in-the-distance/outputs_sim"
BENCHMARK_SCRIPT="${path}/scripts/reconstruct_new.py"
SIM_DIR="${path}/trees/$topology_type/$numcells/$fit/$sim"
                
for alg in ${algs[@]};
do
    SAVE_DIR="${path}/reconstructed/$topology_type/$numcells/$priors_type/$fit/$sim/$alg"
