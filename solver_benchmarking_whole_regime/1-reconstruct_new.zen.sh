...
# CHANGE IO PARAMS HERE
path="/data/yosef2/users/ivalexander13/ivan-cassiopeia-benchmarking/solver_benchmarking_whole_regime"
BENCHMARK_SCRIPT="${path}/1-reconstruct_new.py"
SIM_DIR="/data/yosef2/users/richardz/projects/CassiopeiaV2-Reproducibility/trees/$topology_type/$numcells/$fit/$sim"
                
for alg in ${algs[@]};
do
    SAVE_DIR="${path}/data/$topology_type/$numcells/$priors_type/$fit/$sim/$alg"
